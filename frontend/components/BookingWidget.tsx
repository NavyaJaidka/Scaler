  ...
  if (step === "done") {
    return (
      <div className="booking-panel flex items-start gap-3 py-1">
        ...
        <div>
          <p className="text-sm font-semibold text-green-700 dark:text-green-400">Meeting confirmed!</p>
  ...
  if (step === "confirm" && loading) {
    return (
      <div className="booking-panel flex items-center gap-3 py-2">
        ...
        <span className="text-sm text-gray-600 dark:text-gray-300">Confirming your booking...</span>
      </div>
    );
  }
    ...
    <div className="booking-panel space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={onClose}
          className="w-5 h-5 rounded-full flex items-center justify-center text-gray-400 dark:text-gray-600 hover:text-gray-600 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
        ...
        <>
          <div className="flex gap-2">
            <div className="flex-1">
              <input
                className="w-full border border-gray-200 dark:border-slate-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-400 focus:border-transparent placeholder:text-gray-400 dark:placeholder:text-slate-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors"
          >
            {loading ? (
              <>
              ...
              <button
                ...
                className={`text-xs px-3 py-2 rounded-lg border transition-all duration-150 ${
                  selected?.start === slot.start
                    ...
                    : "bg-white dark:bg-slate-700 text-gray-700 dark:text-slate-300 border-gray-200 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-500 hover:text-blue-700 dark:hover:text-blue-400"
                }`}
              >
                {slot.display}
              </button>
          ...
          <div className="flex gap-2 items-center">
            ...
            {selected && (
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-40 text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors ml-auto"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                </svg>
